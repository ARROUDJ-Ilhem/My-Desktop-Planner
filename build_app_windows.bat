...
set JAVA_VERSION=17
set MAIN_JAR=javaFX-%PROJECT_VERSION%.jar
...
xcopy /S /Q lib\* target\installer\input\libs\
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\tp\javafx\Main.class target\libs\sqlite-jdbc-3.36.0.1.jar  > temp.txt
...
set manual_modules=javafx.controls,javafx.base,javafx.media,javafx.swing,javafx.web,jdk.crypto.ec,jdk.localedata,
